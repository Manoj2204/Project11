...
public class Manufacturer_should_be_able_to_update_stock_and_Admin_can_see_Update_Stock_Test extends BaseClass{
	...
	public void test() throws IOException 
	{
		...
		String AdminUsername2 =fileutils.readDataFromPropertyFile("adminusername");
		String Adminpassword2 =fileutils.readDataFromPropertyFile("adminpassword");
		...
		//loginpage.EnterUsernameAndPassword(Adminpassword2, Adminpassword2);
